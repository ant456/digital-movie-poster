...
# Digital Movie Poster - Install Script
# Updated for Raspberry Pi OS Bookworm (Debian 12), PHP 8.2, Node 20
...
echo -e "\n\nInstalling PHP 8.2 & Requirements\n"

# Use sury.org repo for latest PHP on Debian/Raspberry Pi OS
...
apt-get install php8.2-common php8.2-cli libapache2-mod-php8.2 php8.2-curl php8.2-gd php8.2-mbstring php8.2-xml php8.2-zip php8.2-mysql php8.2-bcmath php8.2-intl php-imagick -y
...
if [ ! -f /etc/php/8.2/apache2/php.ini.orig ]; then
    printf "Backing up PHP.ini configuration file to /etc/php/8.2/apache2/php.ini.orig\n"
...
sed -i "0,/$FIND/s/$FIND/$REPLACE/m" /etc/php/8.2/apache2/php.ini
...
echo "extension=imagick" >> /etc/php/8.2/apache2/php.ini
...
echo -e "\n\nInstalling Node.js 20 LTS and PM2\n"
...
chmod 777 /dev/vchiq 2>/dev/null || true
